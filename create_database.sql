...
GRANT SELECT, INSERT, DELETE, CREATE, ALTER ON b3.* TO 'rstahl'@'localhost';
GRANT SELECT, INSERT, DELETE, CREATE, ALTER ON b3.* TO 'kking'@'localhost';
GRANT SELECT, INSERT, DELETE, CREATE, ALTER ON b3.* TO 'kjohnson'@'localhost';
